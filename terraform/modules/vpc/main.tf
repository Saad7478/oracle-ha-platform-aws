...
resource "aws_route_table_association" "private_primary_assoc" {
  for_each = aws_subnet.private_primary

  subnet_id      = each.value.id
  route_table_id = aws_route_table.private_rt.id
}

resource "aws_route_table_association" "private_standby_assoc" {
  for_each = aws_subnet.private_standby
